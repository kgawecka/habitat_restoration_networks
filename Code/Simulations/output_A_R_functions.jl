...
function store_and_write_species_results(networkName, n_r, n_c, x_r, x_c, n_patch, D, k, DR, RS)
	...
	# output results
	CSV.write(string("../../Output/",networkName,"/",networkName,"_A_R_",RS,"_DR",floor(Int,DR*100),"_out_D",floor(Int,D[k]*100),".csv"), df_out)
...
function store_and_write_patch_results(networkName, x_state, n_patch, D, DR, RS)
	...
	# output results
	CSV.write(string("../../Output/",networkName,"/",networkName,"_A_R_",RS,"_DR",floor(Int,DR*100),"_patch_state.csv"), df_state)
