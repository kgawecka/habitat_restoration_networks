...
function store_and_write_species_results(networkName, n_r, n_c, x_r, x_c, n_patch, D, k)
	...
	# output results
	CSV.write(string("../../Output/",networkName,"/",networkName,"_M_D_out_D",floor(Int,D[k]*100),".csv"), df_out)
...
function store_and_write_patch_results(networkName, x_state, n_patch, D)
	...
	# output results
	CSV.write(string("../../Output/",networkName,"/",networkName,"_M_D_patch_state.csv"), df_state)
